...
This workflow was generated from a YAML template on 2025-09-08.

**Template Version:** 1.0.0  
**Template Format:** 1.0  
**Generated JSON:** `data_quality_check.json`

To modify this workflow, edit the `data_quality_check.yaml` template file and regenerate.
